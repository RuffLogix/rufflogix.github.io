...
const Header: FunctionComponent = () => {
    return (
        <div className='flex gap-3 px-80 py-5 items-baseline'>
            
            <Link href="https://github.com/rufflogix" target='_blank' legacyBehavior> 
                <a className="flex items-baseline gap-1" href="https://github.com/rufflogix" target='_blank'>
                    ...
                    <h1 className='text-2xl'>BlogBlitz</h1>
                </a>
            </Link>
